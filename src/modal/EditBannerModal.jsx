...
const EditBannerModal = ({ isOpen, bannerData, onClose, onSave }) => {
    ...
    const previewUrl = selectedFile 
        ...
        : `https://firebasestorage.googleapis.com/v0/b/mav2025-bd18e.firebasestorage.app/o/images%2Fbanners%2F${formData.imageUrl}?alt=media`; 
        ...
        >
            ...
            >
                <div className="flex justify-between items-center p-5 border-b border-gray-100">
                    <h2 className="text-xl font-extrabold text-gray-800">Editar Banner: {formData.name}</h2>
                    <button 
                        onClick={onClose} 
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">Nombre del Banner</label>
                    ...
                    <div className="mb-6 border p-4 rounded-lg bg-gray-50">
                        <label className="block text-gray-800 text-sm font-bold mb-2">Imagen Actual / Subir Nueva</label>
                            ...
                            <div className="mt-4 border border-gray-300 rounded-md overflow-hidden">
                                ...
                                <img 
                                    ...
                                    onError={(e) => {
                                        ...
                                        e.target.src = "https://placehold.co/400x128/eeeeee/333333?text=Sin+Imagen";
                                    }}
                                />
                            </div>
                        )}
